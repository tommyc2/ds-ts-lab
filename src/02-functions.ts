...
function addInterestToFriend(friend: Friend, interest: string) {
  if (!friend.interests) {
    friend.interests = []
  }
...
console.log(addInterestToFriend(friends[0], 'Programming'));
console.log(addInterestToFriend(friends[0], 'Testing'));